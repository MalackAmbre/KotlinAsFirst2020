...
fun isNumberHappy(number: Int): Boolean {
    val sumPrimesNumber = number / 1000 + (number % 1000) / 100
    val sumLastNumber = (number % 100) / 10 + number % 10
    return sumPrimesNumber == sumLastNumber
}
 ...
 */
fun queenThreatens(x1: Int, y1: Int, x2: Int, y2: Int): Boolean = (x1 == x2) || (y1 == y2) || ((x1 == y2) && (y1 == x2))
