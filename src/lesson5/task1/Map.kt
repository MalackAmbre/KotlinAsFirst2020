...
fun buildGrades(grades: Map<String, Int>): Map<Int, List<String>> {
    val listStudent = mutableMapOf<Int, MutableList<String>>()
    for ((k, v) in grades) {
        val student = listStudent[v]
        if (listStudent.keys.contains(v) && student != null) {
            if (listStudent[v] != null)
                student.add(k)
        } else {
...
fun whoAreInBoth(a: List<String>, b: List<String>): List<String> {
    val whoAreInBoth = mutableSetOf<String>()
    val bb = b.toSet()
    val aa = a.toSet()
    for (i in aa) {
...
fun findSumOfTwo(list: List<Int>, number: Int): Pair<Int, Int> {
    ...
    for (element in list) {
        ...
        val thisList = list.toMutableList()
        map[element] = list.indexOf(element)
        thisList.remove(element)
        if (otherNum in thisList) {
            val a = map[element]
            val b = map[otherNum]
            if (a != null && b != null) {
